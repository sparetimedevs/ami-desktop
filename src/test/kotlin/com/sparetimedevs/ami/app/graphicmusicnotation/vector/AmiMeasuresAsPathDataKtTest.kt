...
class AmiMeasuresAsPathDataKtTest :
    StringSpec({
        ...
        "asPathData should work for 1 measure" {
            ...
            result shouldBe expectedPathData
        }

        "asPathData should work for 2 measures" {
        ...
        "asPathData should work for first 4 measures of example score Heigh Ho Nobody Home" {
            val score = getExampleScoreHeighHoNobodyHome()
            val measures: List<Measure> = score.parts[0].measures
